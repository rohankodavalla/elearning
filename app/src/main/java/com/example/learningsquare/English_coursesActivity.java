...
public class English_coursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        course1 = (LinearLayout) findViewById(R.id.eng_c1_but);
        course2 = (LinearLayout) findViewById(R.id.eng_c2_but);
        course3 = (LinearLayout) findViewById(R.id.eng_c3_but);
        course4 = (LinearLayout) findViewById(R.id.eng_c4_but);
        course5 = (LinearLayout) findViewById(R.id.eng_c5_but);
        course6 = (LinearLayout) findViewById(R.id.eng_c6_but);


        course1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent course1Intent = new Intent(English_coursesActivity.this,English_Course1_Activity.class);
