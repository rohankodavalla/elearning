...
public class Math_result1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_result1);


        ///////////read course number from mathematics course activity
        Intent intent=getIntent();
        String course_number = intent.getStringExtra(Mathematic_CoursesActivity.courseNumber);
        DocumentReference noteRef= db.collection("Mathematics").document(course_number);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),Mathematic_CoursesActivity.class));
            }
        });
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()) {
                    ...
                    if (user != null) {
                        ...
                        {
                            int finalJ = j;
                            db.collection("Users").document(email).collection("Math")
                    ...
                    Toast.makeText(Math_result1_Activity.this, "Document does not exist!", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Math_result1_Activity.this, "Error", Toast.LENGTH_SHORT).show();
                Log.d("Math_tag", e.toString());
            }
    ...
    public void onBackPressed() {
        Intent mathActivity = new Intent(this,Mathematic_CoursesActivity.class);
