...
public class Programming_Course1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_programming_course1);
        ...
        noteRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                    ...
                    seeAnswer.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if(question_number<=3)
                            {
                                ...
                                db.collection("Users").document(email).collection("Programming").document(course_number).collection("Questions").document(question_string_in_db[question_number]).set(usersAnswer).addOnSuccessListener(new OnSuccessListener<Void>() {
                                    @Override
                                ...
                                if (question_number==3)
                                {
                                    ...
                                    Intent course1Intent = new Intent(Programming_Course1_Activity.this,Programming_result1_Activity.class);
                    ...
                    Toast.makeText(Programming_Course1_Activity.this, "Document does not exist!", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Programming_Course1_Activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
