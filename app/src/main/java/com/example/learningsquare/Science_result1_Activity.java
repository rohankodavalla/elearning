...
public class Science_result1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_science_result1);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),Science_CoursesActivity.class));
            }
        });
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()) {
                    ...
                    if (user != null) {
                        ...
                        {
                            int finalJ = j;
                            db.collection("Users").document(email).collection("Science")
                    ...
                    Toast.makeText(Science_result1_Activity.this, "Document does not exist!", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Science_result1_Activity.this, "Error", Toast.LENGTH_SHORT).show();
