...
public class Math_Course1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_course1);
        ...
        noteRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                        ...
                        public void onClick(View v) {
                            ...
                            if(question_number<=3)
                            {
                                ...
                                db.collection("Users").document(email).collection("Math")
                                        ...
                                        .document(question_string_in_db[question_number]).set(usersAnswer)
                                ...
                                if (question_number==3)
                                {
                                    ...
                                    Intent course1Intent = new Intent(Math_Course1_Activity.this
                                            ,Math_result1_Activity.class);
                    ...
                    Toast.makeText(Math_Course1_Activity.this
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Math_Course1_Activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
