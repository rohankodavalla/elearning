...
public class English_result1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_result1);


        ///////////read course number from mathematics course activity
        Intent intent=getIntent();
        String course_number = intent.getStringExtra(English_coursesActivity.courseNumber);
        DocumentReference noteRef= db.collection("English").document(course_number);
        ...
        exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),English_coursesActivity.class));
            }
        });
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()) {
                    ...
                    if (user != null) {
                        ...
                        {
                            int finalJ = j;
                            db.collection("Users").document(email).collection("English")
                                    .document(course_number).collection("Questions")
                                    .document(question_string_in_db[j]).get()
                    ...
                    Toast.makeText(English_result1_Activity.this, "Document does not exist!", Toast.LENGTH_SHORT).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(English_result1_Activity.this, "Error", Toast.LENGTH_SHORT).show();
                Log.d("English_result_tag", e.toString());
            }
    ...
    public void onBackPressed() {
        Intent englishActivity = new Intent(this,English_coursesActivity.class);
