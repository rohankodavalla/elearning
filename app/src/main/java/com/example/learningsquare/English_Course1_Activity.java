...
public class English_Course1_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_english_course1);
        ...
        noteRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if(documentSnapshot.exists()){
                        ...
                        public void onClick(View v) {
                            ...
                            if(question_number<=3)
                            {
                                ...
                                if (question_number==3)
                                {
                                    ...
                                    Intent course1Intent = new Intent(English_Course1_Activity.this
                                            ,English_result1_Activity.class);
                    ...
                    Toast.makeText(English_Course1_Activity.this
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(English_Course1_Activity.this, "Error", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void onBackPressed() {
        Intent mathActivity = new Intent(this,English_coursesActivity.class);
